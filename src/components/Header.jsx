...
{/* Hero Section */}
<div className="hero-section xl:pt-[80px] pb-[70px] flex flex-col md:flex-col lg:max-w-[1024px]:flex-col lg:flex-row items-center justify-between max-w-[90%] md:max-w-[1650px] mx-auto mt-20 px-5 text-center md:text-center lg:text-left">
  
  {/* Profile Image */}
  <motion.div
    className="order-1 md:order-1 lg:max-w-[1024px]:order-1 lg:order-2 mt-8 mb-4 md:mt-0 flex justify-center lg:justify-end w-full"
  ...
  >
    <img
      ...
      className="w-[250px] h-[250px] sm:w-[300px] sm:h-[300px] md:w-[350px] md:h-[350px] lg:w-[400px] lg:h-[400px] p-2 bg-[rgba(94,93,93,0.12)] border-2 border-dotted border-[rgba(94,93,93,0.4)] rounded-full object-cover shadow-[0_0_100px_#000]"
    />
  </motion.div>

  {/* Text Section */}
  <motion.div
    className="order-2 md:order-2 lg:max-w-[1024px]:order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left w-full"
    initial={{ opacity: 0, x: -50 }}
    animate={{ opacity: 1, x: 0 }}
  ...
  >
    ...
    <motion.h1
      ...
      className="text-[1.8em] sm:text-[1.5em] md:text-[2.2em] font-extralight mb-[8px] mt-[4px] w-[90%] md:w-[700px] max-w-full text-[#AEAEAE] font-poppins"
    >
    ...
    <motion.div
      ...
      className="flex flex-col sm:flex-row sm:space-x-4 h-auto text-[0.9em] sm:text-[1em] md:text-[1.2em] font-[200]"
    >
      <a
        href="path-to-cv.pdf"
